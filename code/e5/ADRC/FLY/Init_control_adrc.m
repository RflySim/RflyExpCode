...
%parameters in adrc
TD_R = Pixhawk_CSC.Parameter({single(20), 'SL_TD_R'});
TD_H = Pixhawk_CSC.Parameter({single(1), 'SL_TD_H'});
NLSEF_R = Pixhawk_CSC.Parameter({single(200), 'SL_NLSEF_R'});
NLSEF_H = Pixhawk_CSC.Parameter({single(25), 'SL_NLSEF_H'});
NLSEF_C = Pixhawk_CSC.Parameter({single(5), 'SL_NLSEF_C'});
ESO_B01 = Pixhawk_CSC.Parameter({single(250), 'SL_ESO_B01'});
ESO_B02 = Pixhawk_CSC.Parameter({single(2000), 'SL_ESO_B02'});
ESO_B03 = Pixhawk_CSC.Parameter({single(3000), 'SL_ESO_B03'});
